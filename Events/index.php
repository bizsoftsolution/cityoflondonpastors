    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    <label for="last_name">Event Description</label>
                    <input type="text" id="last_name" name="last_name" placeholder="Last Name" class="form-control"/>
                </div>

                <div class="form-group">
                    <label for="email">Event Date</label>
                    <input type="date" id="email" name="email" placeholder="Email Address" class="form-control"/>
                </div>
